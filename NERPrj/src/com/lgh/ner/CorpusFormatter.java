...
public class CorpusFormatter {
	...
	public static final String TAG_CONTENT_START="<CONTENT>";
	public static final String TAG_CONTENT_END="<\\CONTENT>";
	
	public static String getContentBy(String content,String startTag,String endTag){
		if(content!=null && !content.isEmpty()){
			int startIndex=content.indexOf(startTag);
			int endIndex=content.indexOf(endTag);
			
			return startIndex<endIndex?content.substring(startIndex+startTag.length(), endIndex):null;
		}
		return null;
	}
