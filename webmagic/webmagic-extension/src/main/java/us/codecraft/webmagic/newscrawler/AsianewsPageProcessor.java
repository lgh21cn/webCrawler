...
//		return corpus_time;
		...
		return String.format(CorpusFormatter.CORPUS_DATE_FORMAT, date[2],date[0],date[1]);
	}
...
//		.addRequest(new Request("http://www.asianews.it/news-en/Chinese-police-kill-18-%E2%80%9Cterrorists%E2%80%9D-in-Xinjiang-8180.html").putExtra(AsianViewDetailItem.ORIGIN_URL, AsianViewDetailItem.ORIGIN_URL_CONTENT))
//		.addRequest(new Request("http://www.asianews.it/news-en/Erdogan:-Xinjiang-is-nearly-genocide.-But-the-Islamic-world-remains-cautious-15757.html").putExtra(AsianViewDetailItem.ORIGIN_URL, AsianViewDetailItem.ORIGIN_URL_CONTENT))
//		.addRequest(new Request("http://www.asianews.it/index.php?idn=1&art=13541").putExtra(AsianViewDetailItem.ORIGIN_URL, AsianViewDetailItem.ORIGIN_URL_CONTENT)/*.putExtra(AsianViewDetailItem.ADDNEW, true)*/)
